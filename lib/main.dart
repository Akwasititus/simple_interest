...
class _FormState extends State<Form> {
  ...
  child: Padding(
    ...
    child: ListTile(
      ...
      leading: Radio(
        value: "compound",
        groupValue: _character,
        onChanged: (String? value) { // Accepts nullable string parameter
          setState(() {
            // here it is simple
            _character = value!;
          });
  ...
  child: DropdownButton<String>(
    ...
    value: currentValue,
    onChanged: (String? newValue) { // Accepts nullable string parameter
      _setSelectedValue(newValue!); // Assumes non-nullability
      this.nv = newValue;
      setState(() {
